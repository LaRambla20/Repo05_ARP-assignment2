...
int main(int argc, char *argv[]) {
  ...
  char * arg_list_1[] = { "/usr/bin/konsole",  "-e", "./server_rnbw", argv[2], (char*)NULL }; //argv[] argument that need to be passed to the function "execvp" in order to execute the executable
  ...
  char * arg_list_2[] = { "/usr/bin/konsole",  "-e", "./client_rnbw", argv[1], argv[2], (char*)NULL };  
  int pid1;
  int pid2;
