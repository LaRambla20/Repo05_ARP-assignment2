...
int main(int argc, char *argv[]) {
  ...
  char * arg_list_1[] = { "/usr/bin/konsole",  "-e", "./P1_rnbw", myfifo, (char*)NULL }; //argv[] argument that need to be passed to the function "execvp" in order to execute the executable
  ...
  char * arg_list_2[] = { "/usr/bin/konsole",  "-e", "./P2_rnbw", myfifo, (char*)NULL };  
  int pid1;
  int pid2;
